...
INLINE float Error(float r, Board* b) { return powf(fabs(r - (float)b->wdl / 2.0f), 2.5f); }

INLINE float ErrorGradient(float r, Board* b) { return 2.5f * (r - (float)b->wdl / 2.0f) * sqrtf(fabs(r - (float)b->wdl / 2.0f)); }
